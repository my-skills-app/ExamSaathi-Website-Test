...
function renderApps(list) {
  ...
  list.forEach((app) => {
    ...
    card.setAttribute("title", `${app.name} — Free Mock Test Online`);
    card.setAttribute("aria-label", `${app.name} par free mock test do — ${app.description}`);
    ...
    card.innerHTML = `
      <div class="app-card-top">
        <div class="logo-box logo-box-lg app-icon">
          <img src="${SITE_LOGO}" alt="${app.name} — ExamSaathi Free Mock Test App" width="52" height="52" loading="lazy">
        </div>
        <div class="app-info">
